        ...
        <div className="w-full h-full bg-lightgray flex overflow-x-hidden">
            ...
            <div className='w-1/2'>
                ...
                <div className='mt-12 ml-20 flex'>
                    <button onClick={handleGetStarted} className='px-6 py-2 text-white bg-dodgeblue font-semibold text-2xl border-1 rounded-full flex drop-shadow-lg hover:bg-white hover:text-dodgeblue hover:border-dodgeblue'>
                        Get Started 
