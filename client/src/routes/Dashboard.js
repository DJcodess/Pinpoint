...
import fileWordO from '@iconify-icons/fa/file-word-o';
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg" >
       <img src={PinPointName} alt='pinpoint' className='h-4'/>
        ...
        <div className="flex justify-between mb-6">
          <div className="w-3/5 flex flex-col items-center border border-gray-300 p-4 justify-evenly rounded-lg">
          ...
          <div className="w-2/5 flex flex-col items-center justify-center border border-gray-300 p-4 rounded-lg mx-2">
            <div className="flex gap-2">
            <Icon icon="bi:filetype-csv" color="#0174f0" width="60" height="60" /> 
            <div className="flex flex-col">
            <p className="mt-2 font-semibold text-xl">Import CSV</p>
            <p className="text-xs text-gray2 ">csv, xlsx (MAX. 100MB)</p>
            </div>
            </div>   
            <div className="flex p-2  border border-dashed border-gray2 rounded-lg items-center justify-around w-full mt-3 bg-gray1">
            ...
            {pincodes.map((code, index) => (
              <li key={index} className="flex items-center justify-between mb-2 p-2 bg-white rounded-lg shadow-sm">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">{code.productName}</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <span className="text-sm text-gray-500 mr-4">{code.city}</span>
                  <button className="text-blue-500">{code.state}</button>
                </div>
              </li>
            ))}
          </ul>
